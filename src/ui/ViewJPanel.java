   ...
   /* @SuppressWarnings("unchecked")*/
    ...
    private void initComponents() {
        ...
        tblEmpInfo.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "ID", "Age", "Gender", "Start Date", "Level", "Phone", "Email"
            }
        ));
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {EmpLevel, EmployeeId, StartDate, name});

        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {Age, Email, Gender, Phone});
        ...
        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {EmpLevel, EmployeeId, StartDate, name});

        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {Age, Email, Gender, Phone});
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
       ...
       int selectedRowIndex = tblEmpInfo.getSelectedRow();
        ...
        lblImg.setIcon((ImageIcon) empinfo.getPhoto());        
...
*/
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        int EmployeeId1 = Integer.parseInt(txtID.getText());
        int Age1= Integer.parseInt(txtAge.getText());
        String Gender1 = txtGender.getText();
        String StartDate1 = txtStartDate.getText();
        String Level1 = txtLevel.getText();
        ...
        EmpInfo ei = database.addNewEmp();
                    ...
                    ei.setName(name1);
                    ei.setEmployeeId(EmployeeId1);
                    ei.setAge(Age1);
                    ei.setGender(Gender1);
                    ei.setStartDate(StartDate1);
                    
                    ei.setLevel(Level1);
                    ei.setPhoneNumber(Phone1);
                    ei.setEmail(Email1);
